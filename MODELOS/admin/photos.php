...
<div id="panelCentral">
	...
	<p>Desde este listado puede modificar las fotos de modelos de la agencia que ya aparecen en la página web. Para editar las fotos de un modelo pulse sobre el nombre de la modelo.</p>
    <fieldset>
        <legend>Women</legend>
        <ol>
			<?
