...
<div id="header">
    ...
    <ul id="menu">
        ...
        <li><a id="special_booking" href="special_booking.php" class="selected_menu">Special booking</a></li>
	...
	<div id="modelselector">
		...
		<select name="find_a_model" id="find_a_model">
			...
			<?
				$resultModels1 = mysql_query("SELECT * FROM models_model WHERE model_type = 'special_booking' AND active=1 ORDER BY first_name");
...
<div id="container">
	<div id="menu_models" class="menus">
		<div class="models_guide">
			<ul id="primerplano">
				<?
					$resultModels = mysql_query("SELECT m.id as id, p.url_photo as url_photo, m.first_name as first_name, m.last_name as last_name  FROM models_model m, models_ppal p WHERE m.model_type = 'special_booking' AND m.active=1 AND m.id=p.model_id AND p.active=1 ORDER BY m.first_name");
