...
<div id="panelCentral">
	...
	<p>Desde este listado puede modificar los videos de modelos de la agencia que ya aparecen en la página web. Para editar los videos de un modelo pulse sobre el nombre de la modelo.</p>
    <fieldset>
        <legend>Women</legend>
        <ol>
			<?
			...
			?>
        	<li><a id="<?= $row['id'] ?>" href="videosmodel.php?model_id=<?= $row['id'] ?>"><?= strtoupper(utf8_encode($row['first_name'])) ?> <?= strtoupper(utf8_encode($row['last_name'])) ?></a></li>
			<?
					}
				}
			?>
